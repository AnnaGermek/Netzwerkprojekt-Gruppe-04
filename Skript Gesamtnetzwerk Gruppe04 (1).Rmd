...
el <- read.csv("https://raw.githubusercontent.com/AnnaGermek/Netzwerkprojekt-Gruppe-04/master/Gesamtnetzwerk%20-%20Edgelist.csv", header=T, as.is=T, sep = ",")

# Einlesen der Nodelist

nodes <- read.csv("https://raw.githubusercontent.com/AnnaGermek/Netzwerkprojekt-Gruppe-04/master/Gesamtnetzwerk%20-%20Nodelist.csv", header=T, as.is=T, sep = ",")
...
plot(p, 
     ...
     vertex.label.dist=0,
      ...
      edge.arrow.size=.10,
      main="Gesamtnetzwerk",
      sub="Verbindung rechter Gruppierungen"
...
#Anzahl der Knoten und Kanten im Gesamtnetzwerk berechnen
ecount(p)
vcount(p)
...
el <- 
read.csv("https://raw.githubusercontent.com/AnnaGermek/Netzwerkprojekt-Gruppe-04/master/Gesamtnetzwerk%20-%20Edgelist.csv", 
header=T, as.is=T, sep = ",")

nodes <- 
read.csv("https://raw.githubusercontent.com/AnnaGermek/Netzwerkprojekt-Gruppe-04/master/Gesamtnetzwerk%20-%20Nodelist.csv", 
header=T, as.is=T, sep = ",")
